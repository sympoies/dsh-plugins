...
Version 0.1.5 supports the exact DSH dependency sets for `0.1.1-rc.2`,
`0.1.2-rc.1`, and `0.1.6-alpha.2`, including the latter with Cordis `4.0.4`.
Each set is installed independently and booted by the release gate before publication.
